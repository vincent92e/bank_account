...
/**
 * Provides a 'ViewCardDetailsBlock' block.
 *
 * @Block(
 *  id = "view_card_details_block",
 *  admin_label = @Translation("View card details block"),
 * )
 */
class ViewCardDetailsBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    $output['form'] = $this->formBuilder->getForm('Drupal\bank_account\Form\ViewCardForm');
    return $output;
  }
